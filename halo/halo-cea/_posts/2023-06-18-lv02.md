...
excerpt: '불시착한 헤일로에 흩어진 아군 병사들을 구출하자.'
---
...
죽여도 된다. 플라스마 권총이 있으면 과충전 공격으로 방패를 없애버릴 수도 있다. 별로 위협적인 적은 아니나, 한 가지 성가신 점이라면 이놈들도
과충전 공격을 한다는 것이다. 엘리트와 마찬가지로 마스터 치프도 방어막이 통째로 증발한다.
...
멀기 때문에 굉장히 지루하다.
{%- endcapture %}
{% include halo-achievement.html type="warning" game="cea" name="how_pedestrian" content=content %}
...
![Path to the Boom Skull](/assets/images/halo-cea/lv02/ch01/skull-boom-cliff.webp)
...
![Shortcut to the control panel](/assets/images/halo-cea/lv02/ch01/shortcut.webp)
...
![Entrance to the first crash site](/assets/images/halo-cea/lv02/ch02/site-01/entrance.webp)

왼쪽 절벽을 따라 구조물을 돌면 약간의 물자와 지하로 내려가는 입구가 있다. 코타나의 조언을 따라 구조물의 내부를 확인해야 한다.

![First crash site](/assets/images/halo-cea/lv02/ch02/site-01/substation-entrance.webp)

생존자들이 피신해 있다. 마스터 치프와 만난 후에는 따라온다.

![Survivors in the first crash site](/assets/images/halo-cea/lv02/ch02/site-01/substation.webp)
...
![Exit from the first crash site](/assets/images/halo-cea/lv02/ch02/site-01/exit.webp)

{% capture content -%}
두 번째 구역으로 바로 들어가지 않고 주변을 돌아보면 아무도 없는 구명정이 있다. 그곳에 접근할 때쯤 나머지 밴시 두 대가 나타난다.

![Empty Bumblebee with a Sniper Rifle](/assets/images/halo-cea/lv02/ch02/bumblebee.webp)
{%- endcapture %}
{% include halo-achievement.html type="info" game="cea" name="no_fly_zone" content=content %}
...
![Entrance to the second crash site](/assets/images/halo-cea/lv02/ch02/site-02/entrance.webp)

이곳에 들어오면 추락한 구명정이 가장 먼저 보인다. 계속 가면 꼭대기에 생존자 3명이 있는데 어떻게 할지는 알아서...

두 번째 구역에서도 절벽을 타고 쭉 가면 다른 길이 있다. 밖으로 나오면 강의 상류가 보인다.

![Exit from the second crash site](/assets/images/halo-cea/lv02/ch02/site-02/exit.webp)

아까와 똑같이 강을 건너서 그대로 직진하면 세 번째 구역으로 가는 길목이 있다.

![Entrance to the third crash site](/assets/images/halo-cea/lv02/ch02/site-03/entrance.webp)
...
![Sniper marine](/assets/images/halo-cea/lv02/ch02/site-03/sniper.webp)
...
![Third crash site](/assets/images/halo-cea/lv02/ch02/site-03/bumblebee.webp)
