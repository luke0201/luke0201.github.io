...
{% include halo-achievement.html
  type="info"
  english_name="Didn't Like This Ship Anyways"
  korean_name="이 함선은 원래 맘에 안 들었어"
  content=didnt_like_this_ship_anyways
%}
...
{% include halo-achievement.html
  type="info"
  english_name="Pillar of Awesome"
  korean_name="굉장한 탈출"
  content=pillar_of_awesome
%}
...
{% include halo-achievement.html
  type="warning"
  english_name="Feet Firmly Planted"
  korean_name="단단히 땅을 딛고"
  content=feet_firmly_planted_01
%}
...
{% include halo-achievement.html
  type="info"
  english_name="Before and After"
  korean_name="옛 것과 새 것"
...
{% include halo-achievement.html
  type="info"
  english_name="Skulltaker Halo: CE: Iron"
  korean_name="해골강탈자 Halo: CE: 강철"
  content=skulltaker_iron
%}
...
{% include halo-achievement.html
  ...
  english_name="Feet Firmly Planted"
  korean_name="단단히 땅을 딛고"
  content=feet_firmly_planted_02
%}
...
{% include halo-achievement.html
  type="warning"
  english_name="Walk it Off"
  korean_name="인내는 승리의 열매"
  content=walk_it_off
%}
...
{% include halo-achievement.html
  type="info"
  english_name="My Buddy Chips"
  korean_name="내 친구 칩"
  content=my_buddy_chips
%}
...
{% include halo-achievement.html
  type="warning"
  english_name="Overshields are for Sissies"
  korean_name="남자는 배짱"
  content=overshields_are_for_sissies
%}
