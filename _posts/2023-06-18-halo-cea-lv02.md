...
{% capture flyover_country %}
!["Flyover Country" achievement logo](/assets/images/halo-cea/achievements/flyover-country.jpg){: .align-left}
**[스쳐가는 지역]** 20분 이내에 레벨을 완료하면 도전 과제를 달성한다.
{% endcapture %}
<div class="halo-achievement--info">{{ flyover_country | markdownify }}</div>

{% capture giant_hula_hoop %}
!["Giant Hula Hoop" achievement logo](/assets/images/halo-cea/achievements/giant-hula-hoop.jpg){: .align-left}
**[거대한 훌라후프]** 12,000점 이상을 획득하면 도전 과제를 달성한다.
{% endcapture %}
<div class="halo-achievement--info">{{ giant_hula_hoop | markdownify }}</div>
...
**[해골강탈자 Halo: CE: 꽝!]** 내리막길 오른쪽으로 절벽을 따라 좁은 길이 있다.
